<template>
  <div id="loading" :class="$style.loading">
    <svg
      id="loading_anime"
      :class="$style.loading_anime"
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 498.04 118.6"
    >
      <defs>
        <style>
          .cls-1 {
        ...
        <g id="logo_board" data-name="" class="cls-1">
          ...
          <g>
            <path
              ...
              :class="$style.c"
              class="cls-2"
              d="M289.7,67.4c-1.8,0-3.3,2.7-3.3,2.7-10,16.05-23.1,22.2-31,22.2-3.45,0-8.4-3.3-8.4-7.8,0-16.5,8.55-36.75,14.4-36.75.75,0,1.35.6,1.35.9,0,1.65-4.05,7.2-4.05,10.8,0,2.55,7.65,7.35,11.4,7.35,3,0,8.55-12.3,8.55-18.3S266.75,35,256.85,35c-18.15,0-33,28.8-33,49.8,0,10.65,15,20.7,28.65,20.7,14.55,0,29.4-11.4,40.35-28.65,0,0,2.1-3.45,2.1-5.25S291.8,67.4,289.7,67.4Z"
            />
          </g>
          <g data-name="c">
            <path
              ...
              :class="$style.c_2"
              class="cls-2"
              d="M344.7,67.4c-1.8,0-3.3,2.7-3.3,2.7-10,16.05-23.1,22.2-31,22.2-3.45,0-8.4-3.3-8.4-7.8,0-16.5,8.55-36.75,14.4-36.75.75,0,1.35.6,1.35.9,0,1.65-4.05,7.2-4.05,10.8,0,2.55,7.65,7.35,11.4,7.35,3,0,8.55-12.3,8.55-18.3S321.75,35,311.85,35c-18.15,0-33,28.8-33,49.8,0,10.65,15,20.7,28.65,20.7,14.55,0,29.4-11.4,40.35-28.65,0,0,2.1-3.45,2.1-5.25S346.8,67.4,344.7,67.4Z"
            />
          </g>
          <g data-name="o">
            <path
          ...
          <g>
            <path
              ...
              :class="$style.i"
              class="cls-2"
              d="M492.94,77.31c-1.95,0-3.15,2.7-3.15,2.7-7.65,13.5-15.45,22.8-19.8,22.8-.45,0-1.5-.75-1.5-1.35,0-10.5,12-43.2,12-46.65,0-2.85-12-9.9-15-9.9-3.3,0-5.4,1.05-6,3.15-2.55,9.3-13.2,47.25-13.2,54.3,0,6.75,13.35,13,21.75,13,10.8,0,19.8-13.65,27.9-28.65,0,0,2.1-3.45,2.1-5.25S494.89,77.31,492.94,77.31Zm-14.4-37.65c6,0,9.9-10.95,9.9-16.95,0-4.95-7.8-7.8-11.85-7.8-6.15,0-9.9,11-9.9,17C466.69,36.81,474.49,39.66,478.54,39.66Z"
            />
          </g>
        </g>
      </g>
  ...
  methods: {
    PathCheck() {
      document.addEventListener("DOMContentLoaded", function () {
        ...
        console.log(document.getElementById("r").getTotalLength());
        console.log(document.getElementById("o").getTotalLength());
        console.log(document.getElementById("c").getTotalLength());
        console.log(document.getElementById("c-2").getTotalLength());
        console.log(document.getElementById("o-2").getTotalLength());
        console.log(document.getElementById("l").getTotalLength());
